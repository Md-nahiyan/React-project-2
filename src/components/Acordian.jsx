  ...
  return (
    <div className="w-[40%] mx-auto py-[100px]">
      ...
      <h2 id="accordion-color-heading-1">
        <button
          type="button"
          className={`flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border  border-b-5 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800 gap-3 mb-3 ${open === 1 ? "bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white" : ""}`}
          onClick={() => toggle(1)}
          aria-expanded={open === 1}
          aria-controls="accordion-color-body-1"
        >
          <span className="text-[#3b3b3b] font-semibold">How can I tell if using AI is the right solution for my problem?</span>
          <svg
            data-accordion-icon
          ...
          {/* <i className= {`"fa-solid fa-plus " w-3 h-3 shrink-0 ${open === 1 ? "rotate-180" : ""}`}></i>
      ...
      >
        <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
          <p className="mb-2 text-[#3b3b3b] font-semibold dark:text-gray-400">
      ...
      <h2 id="accordion-color-heading-2">
        <button
          type="button"
          className={`flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-5 border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800 gap-3 mb-3 ${open === 2 ? "bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white" : ""}`}
          onClick={() => toggle(2)}
          aria-expanded={open === 2}
          aria-controls="accordion-color-body-2"
        >
          <span className="text-[#3b3b3b] font-semibold">How long does an AI solution take to implement?</span>
          <svg
            data-accordion-icon
      ...
      >
        <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
          <p className="mb-2 text-[#3b3b3b] dark:text-gray-400">
      ...
      <h2 id="accordion-color-heading-3">
        <button
          type="button"
          className={`flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border  border-b-5 border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800 gap-3 ${open === 3 ? "bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white" : ""}`}
          onClick={() => toggle(3)}
          aria-expanded={open === 3}
          aria-controls="accordion-color-body-3"
        >
          <span className="text-[#3b3b3b] font-semibold">Will we need to make changes in our teams?</span>
          <svg
            data-accordion-icon
