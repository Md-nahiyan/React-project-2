...
export default function Pricing() {
  return (
    <div>
        ...
        <div className="w-[80%] mx-auto mt-[20px] px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
                <div className="grid grid-cols-1  gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8">
                    <div className="divide-y bg-white divide-gray-200 rounded-[50px] border border-gray-200 shadow-sm">
                        <div className="p-6 sm:px-8 bg-[#f6f6f6] hover:bg-white m-2 rounded-[40px] hover:shadow-2xl hover:duration-75">
                            <h2 className="text-lg font-blod text-gray-900">
                            Pro
                                <span className="sr-only">Plan</span>
                            </h2>

                            <p className="mt-2 sm:mt-4">
                                <strong className="text-3xl font-bold text-gray-900 sm:text-4xl block"> $199/m </strong>
                                <span>Price breakdown here</span>
                            </p>
